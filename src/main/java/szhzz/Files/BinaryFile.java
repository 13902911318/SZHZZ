...
public class BinaryFile {
     ...
     * @throws Exception Will be thrown if this method is
    ...
    public float readFloat() throws java.io.IOException {
        ...
        if (_signed)
            if ((result & 0x80000000L) == 0x80000000L)
                result = (int) -(0x100000000L - result);

        return Float.intBitsToFloat(result);

    }

    public float readFloat2() throws java.io.IOException, EOFException {
        byte[] array = new byte[4];
        array[0] = _file.readByte();
        array[1] = _file.readByte();
        array[2] = _file.readByte();
        array[3] = _file.readByte();
     ...
     * @throws java.io.IOException If an IO exception occurs.
     */
    public void writeFixedString(String str, int length) throws java.io.IOException {
        int i;
     ...
     * @throws java.io.IOException If an IO exception occurs.
     */
    public void writeFixedZeroString(String str, int length) throws java.io.IOException {
